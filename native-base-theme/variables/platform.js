...
export default {
  ...
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? 'Rubik-Regular' : 'Rubik-Regular',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'Rubik-Regular' : 'Rubik-Regular',
  fontSizeBase: 15,
  get fontSizeH1() {
    return this.fontSizeBase * 3.2;
  },
  get fontSizeH2() {
  ...
  // Title
  titleFontfamily: platform === PLATFORM.IOS ? 'Rubik-Regular' : 'Rubik-Regular',
